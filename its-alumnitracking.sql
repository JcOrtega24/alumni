...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 18, 2023 at 05:37 AM
...
INSERT INTO `accounts` (`Id`, `IdNumber`, `Username`, `Password`, `FirstName`, `LastName`, `MiddleName`, `Email`, `ContactNumber`, `BranchId`, `DepartmentId`, `AddedDate`, `userData`) VALUES
...
(52, 123, 'useremployee@gmail.com', '$2y$10$69RK3hdtDK2HfG/tFOdoJeS2Ipia8mdg42HDw38bBV/YlwN4ApZAy', 'New', 'User', 'Employee', 'useremployee@gmail.com', '09123456789', 1, 1, '2022-09-27', 'Employee'),
(53, 123456, 'shin@gmail.com', '$2y$10$2AhJOoTm4HeNA1pC4cUaJeKvB9WIrXpbgd2bfF9.9kie..mDI3SCK', 'shina', 'villarin', 'm.', 'shin@gmail.com', '08876776576', 1, 1, '2022-11-15', 'Employee'),
(54, 0, 'cs.legarda@arellano.edu.ph', '$2y$10$upzFGHZ9v7Xm8nSZkCtFguKJEC.L5EWYA.Xn7HkGr9rsxPzq69Q/2', 'computer', 'main', 'science', 'cs.legarda@arellano.edu.ph', '12345678901', 1, 1, '2022-12-01', 'Administrator');
...
(6, 'admin@gmail.com', '123456', 'FIRST ', 'Mid', 'AUTHOR', '163934404_907750563395825_8575706052885231783_n.png', '2021-10-30', '1'),
...
CREATE TABLE `alumni` (
  ...
  `elementaryGraduated` text NOT NULL,
  `elementaryHonors` text NOT NULL,
  `highschool` text NOT NULL,
  `highschoolGraduated` text NOT NULL,
  `highschoolHonors` text NOT NULL,
  `college` text NOT NULL,
  `collegeDegree` text NOT NULL,
  `collegeGraduated` text NOT NULL,
  `collegeHonors` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `alumni` (`id`, `firstname`, `middleName`, `lastname`, `photo`, `gender`, `birthday`, `email`, `contact`, `telephone`, `socMed`, `interest`, `schoolAttended`, `CurrentWork`, `courseGraduated`, `created_on`, `password`, `address`, `bio`, `guid`, `studNo`, `studStatus`, `studDes`, `studOR`, `studDate`, `studRemarks`, `employerNo`, `mailingAddress`, `presentAddress`, `provincialAddress`, `companyAddress`, `fbURL`, `twitterURL`, `gmailURL`, `linkURL`, `otherURL`, `major`, `awards`, `company`, `position`, `location`, `description`, `employeeYear`, `elementary`, `elementaryGraduated`, `elementaryHonors`, `highschool`, `highschoolGraduated`, `highschoolHonors`, `college`, `collegeDegree`, `collegeGraduated`, `collegeHonors`) VALUES
(1700001, 'jay', 'luz', 'manalo', ' ', 'male', '2022-09-11', 'maryanne.alburo@arellano.edu.ph', '02028928282', '', '', '', 'Plaridel Campus - Mandaluyong', '', '1', '2022-09-13 12:20:10', '12345', '', '', '', '19-34567', '', '', '', '', '17-00001', '', 'maryanne.alburo@arellano.edu.ph', '', '', 'maryanne.alburo@arellano.edu.ph', 'cdcdcd     ', 'ddsdsds', '', '', '', '', '', '', '', '', '', '', 'Pasay     ', '22222', '22222', 'mabolo elementary      ', '2012', '1', '45', '34', '2017', '34'),
(1700003, 'sample', 'sample', 'sample', ' ', '', '2020-10-26', 'sample@arellano.edu.ph', '', '', '-', '1', 'Juan Sumulong Campus - Legarda', ' ', '1', '0000-00-00 00:00:00', '$2y$10$ARJNn1sb9Q7rcZLk3LCC7emDOCZ2vt3R0ABt3Wq/7D0LzVIJ3KXQq', '', '', '', '19-34568', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `alumnisurvey`
--
...
--
-- Dumping data for table `alumnisurvey`
--

INSERT INTO `alumnisurvey` (`Id`, `studID`, `Description`, `AddedDate`, `courseRelated`, `currentlyEmp`) VALUES
(1700001, '1700001', '{\"id\":\"1700001\",\"pursueStudy\":\"Yes\",\"training\":\"bscs-it\",\"creditsEarned\":\"none\",\"trainingIns\":\"university\",\"pursueFurther\":\"For Promotion\",\"pursueOthers\":\"\",\"skills\":\"it\",\"trainingIn\":\"university\",\"otherTraining\":\"none\",\"skillsandtraining\":\"Very useful\",\"overalAll\":\"Very effective\",\"personalExp\":\"Very satisfied\",\"compare\":\"Better prepared\",\"prepareOthers\":\"\",\"Award\":\"ccsa\",\"GrantingInstitution\":\"baaa\",\"year\":\"2010\",\"getJob\":\" \",\"acquired\":\" \",\"acquiredOthers\":\" \",\"employementStat\":\"Local\",\"currentlyEmp\":\"Yes\",\"unEmployed\":\"\",\"typeOrg\":\"Private\",\"otherOrg\":\"\",\"presentStatus\":\"Regular/Permanent\",\"presentEmployer\":\"none\",\"position\":\"graduated\",\"when\":\"july 2020\",\"occupationClass\":\"Managing Proprietor or Supervisor\",\"otherClass\":\"\",\"compYears\":\"1-5\",\"incomeRanged\":\"10,000-20,000\",\"statisfied\":\"Satisfied\",\"firstJob\":\" \",\"suggestions\":\"na\",\"alumnisuggest\":\"na\"}', '2022-09-13', 'Yes', 'Yes'),
(1700003, '1700003', '{\"id\":\"1700003\",\"pursueStudy\":\"Yes\",\"training\":\"\",\"creditsEarned\":\"\",\"trainingIns\":\"\",\"pursueFurther\":\"For Promotion\",\"pursueOthers\":\"\",\"skills\":\"\",\"trainingIn\":\"\",\"otherTraining\":\"\",\"skillsandtraining\":\"Very useful\",\"overalAll\":\"Very effective\",\"personalExp\":\"Very satisfied\",\"compare\":\"Better prepared\",\"prepareOthers\":\"sample\",\"Award\":\"sample\",\"GrantingInstitution\":\"sample\",\"year\":\"sample\",\"getJob\":\" \",\"acquired\":\" \",\"acquiredOthers\":\" \",\"employementStat\":\"Local\",\"currentlyEmp\":\"Yes\",\"unEmployed\":\"\",\"typeOrg\":\"Private\",\"otherOrg\":\"\",\"presentStatus\":\"Regular/Permanent\",\"presentEmployer\":\"sample\",\"position\":\"sample\",\"when\":\"2010\",\"occupationClass\":\"Corporate Executive or Manager\",\"otherClass\":\"\",\"compYears\":\"1-5\",\"incomeRanged\":\"Below 10,000\",\"statisfied\":\"Very satisfied\",\"firstJob\":\" \",\"suggestions\":\"sample\",\"alumnisuggest\":\"sample\"}', '2023-09-28', 'Yes', 'Yes');
...
(120, '120', '2022', '2022-08-08'),
(121, '121', '2022', '2022-08-08'),
(124, '124', '2022', '2022-08-08'),
(125, '125', '2022', '2022-08-08'),
(126, '126', '2321', '2022-08-23'),
(127, '127', '2018', '2022-08-23'),
(129, '129', '1980', '2022-09-05'),
(132, '1700001', '2018', '2022-09-13'),
(135, '1700003', '2018', '2023-09-28');
...
(3, 'Jose Abad Santos Campus', 'Pasay', '2022-11-15'),
(4, 'Andres Bonifacio Campus', 'Pasig', '2022-11-15'),
(5, 'Jose Rizal Campus', 'Malabon', '2022-11-15'),
(6, 'Apolinario Mabini Campus', 'Pasay', '2022-11-15'),
(7, 'Elisa Esguerra Campus', 'Malabon', '2022-11-15');
...
(55, 'sds', 'ew', 'wed', 'contents/20220905-empty', '2022-09-05 11:40:12', '25', 'Administrator', 'Jobs', 'd', 'Engineering', 1, 'Approved'),
(61, 'flower', 'flowerfield', 'vacation', 'contents/20220913-han-chenxu-YdAqiUkUoWA-unsplash.jpg', '2022-09-13 13:01:12', '1700001', 'Alumni', 'Announcements', '', '', 0, 'Approved'),
(63, 'fun', 'beach', 'vacation', 'contents/20220913-abf172ec2049b81d830b8f12acafedb8.jpg', '2022-09-13 13:18:04', '1700001', 'Alumni', 'Announcements', '', '', 0, 'Approved'),
(64, 'flower', 'dsvds', 'dsvsdv', 'contents/20220913-han-chenxu-YdAqiUkUoWA-unsplash.jpg', '2022-09-13 13:33:19', '1700001', 'Alumni', 'Announcements', '', '', 0, 'Approved'),
(72, 'Sample Event', 'Sample Event', 'Sample Event', 'contents/20230531-6951218.jpg', '2023-05-31 13:06:50', '54', 'Administrator', 'Events', '', '', 0, 'Approved');
...
(1164, 'masteraffy@gmail.com', 'User Logged In', '2022-08-07 14:01:16', 'Login'),
(1165, 'masteraffy@gmail.com', 'User Logged In', '2022-08-07 15:14:45', 'Login'),
(1166, 'masteraffy@gmail.com', 'User Logged Out', '2022-08-07 15:20:51', 'Login'),
(1167, 'masteraffy@gmail.com', 'User Logged In', '2022-08-07 15:20:58', 'Login'),
(1168, 'masteraffy@gmail.com', 'User Logged In', '2022-08-07 21:54:20', 'Login'),
(1169, 'masteraffy@gmail.com', 'User Created an Alumni Account: testemail@gmail.com', '2022-08-07 22:19:39', 'Admin Account'),
(1170, 'masteraffy@gmail.com', 'User Logged Out', '2022-08-07 22:40:08', 'Login'),
(1171, 'masteraffy@gmail.com', 'User Logged In', '2022-08-08 15:19:52', 'Login'),
(1172, 'masteraffy@gmail.com', 'User Logged In', '2022-08-08 15:20:24', 'Login'),
(1173, 'masteraffy@gmail.com', 'User Logged In', '2022-08-08 15:24:16', 'Login'),
(1174, 'masteraffy@gmail.com', 'User Logged In', '2022-08-08 15:35:27', 'Login'),
(1175, 'masteraffy@gmail.com', 'User Logged Out', '2022-08-08 15:36:03', 'Login'),
(1176, 'masteraffy@gmail.com', 'User Logged In', '2022-08-08 15:59:09', 'Login'),
(1177, 'masteraffy@gmail.com', 'User Logged In', '2022-08-08 15:59:10', 'Login'),
(1178, 'masteraffy@gmail.com', 'User Updated an Alumni Account: ', '2022-08-08 15:59:31', 'Admin Account'),
(1179, 'masteraffy@gmail.com', 'User Logged Out', '2022-08-08 15:59:43', 'Login'),
(1180, 'masteraffy@gmail.com', 'User Logged In', '2022-08-08 16:26:05', 'Login'),
(1181, 'masteraffy@gmail.com', 'User Deleted an Alumni Account: 118', '2022-08-08 16:27:11', 'Admin Account'),
(1182, 'masteraffy@gmail.com', 'User Created an Alumni Account: testemail@gmail.com', '2022-08-08 16:29:27', 'Admin Account'),
(1183, 'masteraffy@gmail.com', 'User Deleted an Alumni Account: 119', '2022-08-08 16:30:28', 'Admin Account'),
(1184, 'masteraffy@gmail.com', 'User Created an Alumni Account: testemail@gmail.com', '2022-08-08 16:31:16', 'Admin Account'),
(1185, 'masteraffy@gmail.com', 'User Logged Out', '2022-08-08 16:33:17', 'Login'),
(1186, 'masteraffy@gmail.com', 'User Logged In', '2022-08-08 16:34:27', 'Login'),
(1187, 'masteraffy@gmail.com', 'User Created an Alumni Account: testemail@gmail.com', '2022-08-08 16:35:16', 'Admin Account'),
(1188, 'masteraffy@gmail.com', 'User Logged Out', '2022-08-08 16:35:22', 'Login'),
(1189, 'masteraffy@gmail.com', 'User Logged In', '2022-08-08 16:41:03', 'Login'),
(1190, 'masteraffy@gmail.com', 'User Logged Out', '2022-08-08 16:41:23', 'Login'),
(1191, 'masteraffy@gmail.com', 'User Logged In', '2022-08-08 16:41:32', 'Login'),
(1192, 'masteraffy@gmail.com', 'User Logged Out', '2022-08-08 16:41:41', 'Login'),
(1193, 'masteraffy@gmail.com', 'User Logged In', '2022-08-08 17:15:55', 'Login'),
(1194, 'masteraffy@gmail.com', 'User Logged Out', '2022-08-08 17:16:00', 'Login'),
(1195, 'masteraffy@gmail.com', 'User Logged In', '2022-08-08 17:18:02', 'Login'),
(1196, 'masteraffy@gmail.com', 'User Updated an Alumni Account: ', '2022-08-08 17:18:23', 'Admin Account'),
(1197, 'masteraffy@gmail.com', 'User Logged Out', '2022-08-08 17:18:28', 'Login'),
(1198, 'masteraffy@gmail.com', 'User Logged In', '2022-08-08 17:21:02', 'Login'),
(1199, 'masteraffy@gmail.com', 'User Logged Out', '2022-08-08 17:21:11', 'Login'),
(1200, 'masteraffy@gmail.com', 'User Logged In', '2022-08-08 17:28:53', 'Login'),
(1201, 'masteraffy@gmail.com', 'User Created an Alumni Account: testemail@gmail.com', '2022-08-08 17:30:09', 'Admin Account'),
(1202, 'masteraffy@gmail.com', 'User Logged Out', '2022-08-08 17:30:19', 'Login'),
(1203, 'masteraffy@gmail.com', 'User Logged In', '2022-08-08 17:31:02', 'Login'),
(1204, 'masteraffy@gmail.com', 'User Logged Out', '2022-08-08 17:31:05', 'Login'),
(1205, 'masteraffy@gmail.com', 'User Logged In', '2022-08-08 17:31:43', 'Login'),
(1206, 'masteraffy@gmail.com', 'User Updated an Alumni Account: ', '2022-08-08 17:32:01', 'Admin Account'),
(1207, 'masteraffy@gmail.com', 'User Logged Out', '2022-08-08 17:32:05', 'Login'),
(1208, 'masteraffy@gmail.com', 'User Logged In', '2022-08-08 17:34:59', 'Login'),
(1209, 'masteraffy@gmail.com', 'User Deleted an Alumni Account: 122', '2022-08-08 17:35:07', 'Admin Account'),
(1210, 'masteraffy@gmail.com', 'User Created an Alumni Account: testemail@gmail.com', '2022-08-08 17:35:36', 'Admin Account'),
(1211, 'masteraffy@gmail.com', 'User Logged Out', '2022-08-08 17:35:42', 'Login'),
(1212, 'masteraffy@gmail.com', 'User Logged In', '2022-08-08 17:36:29', 'Login'),
(1213, 'masteraffy@gmail.com', 'User Deleted an Alumni Account: 123', '2022-08-08 17:36:36', 'Admin Account'),
(1214, 'masteraffy@gmail.com', 'User Created an Alumni Account: testemail@gmail.com', '2022-08-08 17:37:10', 'Admin Account'),
(1215, 'masteraffy@gmail.com', 'User Logged Out', '2022-08-08 17:37:14', 'Login'),
(1216, 'masteraffy@gmail.com', 'User Logged In', '2022-08-08 22:10:04', 'Login'),
(1217, 'masteraffy@gmail.com', 'User Logged In', '2022-08-08 22:13:13', 'Login'),
(1218, 'masteraffy@gmail.com', 'User Created an Alumni Account: johndoe@gmail.com', '2022-08-08 22:14:32', 'Admin Account'),
(1219, 'masteraffy@gmail.com', 'User Logged Out', '2022-08-08 22:14:54', 'Login'),
(1220, 'masteraffy@gmail.com', 'User Logged In', '2022-08-21 21:31:40', 'Login'),
(1221, 'masteraffy@gmail.com', 'User Logged In', '2022-08-21 22:11:46', 'Login'),
(1222, 'masteraffy@gmail.com', 'User Logged Out', '2022-08-21 22:32:28', 'Login'),
(1223, 'masteraffy@gmail.com', 'User Logged In', '2022-08-21 22:38:25', 'Login'),
(1224, 'masteraffy@gmail.com', 'User Logged Out', '2022-08-21 22:50:22', 'Login'),
(1225, 'masteraffy@gmail.com', 'User Logged In', '2022-08-22 21:25:18', 'Login'),
(1226, 'masteraffy@gmail.com', 'User Logged In', '2022-08-23 10:38:23', 'Login'),
(1227, 'masteraffy@gmail.com', 'User Logged In', '2022-08-23 11:54:44', 'Login'),
(1228, 'masteraffy@gmail.com', 'User Created an Alumni Account: testemail@gmail.com', '2022-08-23 12:05:17', 'Admin Account'),
(1229, 'masteraffy@gmail.com', 'User Logged In', '2022-08-23 13:27:17', 'Login'),
(1230, 'masteraffy@gmail.com', 'User Created an Alumni Account: jesperjanmanalo@gmail.com', '2022-08-23 13:30:30', 'Admin Account'),
(1231, 'masteraffy@gmail.com', 'User Logged Out', '2022-08-23 13:31:03', 'Login'),
(1232, '', 'User Logged Out', '2022-08-23 13:31:05', 'Login'),
(1233, 'masteraffy@gmail.com', 'User Logged In', '2022-08-23 13:31:20', 'Login'),
(1234, 'masteraffy@gmail.com', 'User Logged Out', '2022-08-23 13:31:29', 'Login'),
(1235, 'masteraffy@gmail.com', 'User Logged In', '2022-08-23 13:34:11', 'Login'),
(1236, 'masteraffy@gmail.com', 'User Logged In', '2022-08-23 13:39:42', 'Login'),
(1237, 'masteraffy@gmail.com', 'User Logged In', '2022-08-23 13:54:25', 'Login'),
(1238, 'masteraffy@gmail.com', 'User Logged Out', '2022-08-23 13:54:34', 'Login'),
(1239, '', 'User Logged Out', '2022-08-23 13:57:08', 'Login'),
(1240, 'masteraffy@gmail.com', 'User Logged In', '2022-09-05 10:41:24', 'Login'),
(1241, 'masteraffy@gmail.com', 'User Created an Alumni Account: aianne1226@gmail.com', '2022-09-05 10:45:58', 'Admin Account'),
(1242, 'masteraffy@gmail.com', 'User Updated an Alumni Account: ', '2022-09-05 10:46:49', 'Admin Account'),
(1243, 'masteraffy@gmail.com', 'User Updated an Alumni Account: ', '2022-09-05 10:47:03', 'Admin Account'),
(1244, 'masteraffy@gmail.com', 'User Logged Out', '2022-09-05 10:47:13', 'Login'),
(1245, 'masteraffy@gmail.com', 'User Logged In', '2022-09-05 10:50:13', 'Login'),
(1246, 'masteraffy@gmail.com', 'User Deleted an Alumni Account: 128', '2022-09-05 10:51:59', 'Admin Account'),
(1247, 'masteraffy@gmail.com', 'User Created an Alumni Account: jesperm@gmail.com', '2022-09-05 10:54:29', 'Admin Account'),
(1248, 'masteraffy@gmail.com', 'User Updated an Announcement / Events: 51', '2022-09-05 10:56:19', 'Announcement / Events'),
(1249, 'masteraffy@gmail.com', 'User Updated an Announcement / Events: 52', '2022-09-05 10:58:44', 'Announcement / Events'),
(1250, 'masteraffy@gmail.com', 'User Logged In', '2022-09-05 11:20:56', 'Login'),
(1251, 'masteraffy@gmail.com', 'User Created an Alumni Account: aianne12@gmail.com', '2022-09-05 11:24:26', 'Admin Account'),
(1252, 'masteraffy@gmail.com', 'User Logged Out', '2022-09-05 11:24:45', 'Login'),
(1253, 'masteraffy@gmail.com', 'User Logged In', '2022-09-05 11:39:08', 'Login'),
(1254, 'masteraffy@gmail.com', 'User Updated an Announcement / Events: 53', '2022-09-05 11:39:19', 'Announcement / Events'),
(1255, 'masteraffy@gmail.com', 'User Updated an Announcement / Events: 54', '2022-09-05 11:39:44', 'Announcement / Events'),
(1256, 'masteraffy@gmail.com', 'User Created an Job Post: sds', '2022-09-05 11:40:12', 'Jobs'),
(1257, 'masteraffy@gmail.com', 'User Logged In', '2022-09-05 13:07:03', 'Login'),
(1258, 'masteraffy@gmail.com', 'User Created an Employee Account: shin@gmail.com', '2022-09-05 13:07:47', 'Employee Account'),
(1259, 'masteraffy@gmail.com', 'User Deleted an Employee Account Id: 50', '2022-09-05 13:08:13', 'Employee Account'),
(1260, 'masteraffy@gmail.com', 'User Created an Employee Account: marro@gmail.com', '2022-09-05 13:10:24', 'Employee Account'),
(1261, 'marro@gmail.com', 'User Logged In', '2022-09-05 13:11:10', 'Login'),
(1262, 'marro@gmail.com', 'User Deleted an Employee Account Id: 51', '2022-09-05 13:12:29', 'Employee Account'),
(1263, 'masteraffy@gmail.com', 'User Logged In', '2022-09-05 13:12:50', 'Login'),
(1264, 'masteraffy@gmail.com', 'User Logged Out', '2022-09-05 13:13:27', 'Login'),
(1265, 'masteraffy@gmail.com', 'User Logged In', '2022-09-05 13:15:41', 'Login'),
(1266, 'masteraffy@gmail.com', 'User Logged In', '2022-09-05 13:41:13', 'Login'),
(1267, 'masteraffy@gmail.com', 'User Updated an Announcement / Events: 56', '2022-09-05 13:45:07', 'Announcement / Events'),
(1268, 'masteraffy@gmail.com', 'User Created an Alumni Account: ay01@gmail.com', '2022-09-05 13:51:35', 'Admin Account'),
(1269, 'masteraffy@gmail.com', 'User Logged In', '2022-09-05 14:01:12', 'Login'),
(1270, 'masteraffy@gmail.com', 'User Logged In', '2022-09-13 11:38:47', 'Login'),
(1271, 'masteraffy@gmail.com', 'User Deleted an Alumni Account: 1700001', '2022-09-13 11:40:52', 'Admin Account'),
(1272, 'masteraffy@gmail.com', 'User Deleted an Alumni Account: 1700001', '2022-09-13 11:40:52', 'Admin Account'),
(1273, 'masteraffy@gmail.com', 'User Deleted an Alumni Account: 1700000', '2022-09-13 11:40:55', 'Admin Account'),
(1274, 'masteraffy@gmail.com', 'User Logged In', '2022-09-13 11:46:39', 'Login'),
(1275, 'masteraffy@gmail.com', 'User Logged In', '2022-09-13 11:49:12', 'Login'),
(1276, 'masteraffy@gmail.com', 'User Created an Alumni Account: maryanne.alburo@arellano.edu.ph', '2022-09-13 12:20:10', 'Admin Account'),
(1277, 'masteraffy@gmail.com', 'User Updated an Announcement / Events: 57', '2022-09-13 12:43:08', 'Announcement / Events'),
(1278, 'masteraffy@gmail.com', 'User Updated an Announcement / Events: 58', '2022-09-13 12:44:02', 'Announcement / Events'),
(1279, 'masteraffy@gmail.com', 'User Updated an Announcement / Events: 59', '2022-09-13 12:50:19', 'Announcement / Events'),
(1280, 'masteraffy@gmail.com', 'User Updated an Announcement / Events: 60', '2022-09-13 12:58:09', 'Announcement / Events'),
(1281, 'masteraffy@gmail.com', 'User Updated an Announcement / Events: 61', '2022-09-13 13:01:23', 'Announcement / Events'),
(1282, 'masteraffy@gmail.com', 'User Created an Announcement / Events: test', '2022-09-13 13:06:04', 'Announcement / Events'),
(1283, 'masteraffy@gmail.com', 'User Logged In', '2022-09-13 13:18:18', 'Login'),
(1284, 'masteraffy@gmail.com', 'User Updated an Announcement / Events: 63', '2022-09-13 13:18:25', 'Announcement / Events'),
(1285, 'masteraffy@gmail.com', 'User Logged In', '2022-09-13 13:33:35', 'Login'),
(1286, 'masteraffy@gmail.com', 'User Updated an Announcement / Events: 64', '2022-09-13 13:33:43', 'Announcement / Events'),
(1287, 'masteraffy@gmail.com', 'User Logged Out', '2022-09-13 13:50:19', 'Login'),
(1288, 'masteraffy@gmail.com', 'User Logged In', '2022-09-19 19:59:47', 'Login'),
(1289, 'masteraffy@gmail.com', 'User Logged In', '2022-09-27 20:29:10', 'Login'),
(1290, 'masteraffy@gmail.com', 'User Created an Employee Account: useremployee@gmail.com', '2022-09-27 21:03:05', 'Employee Account'),
(1291, 'masteraffy@gmail.com', 'User Logged In', '2022-10-18 13:29:33', 'Login'),
(1292, 'masteraffy@gmail.com', 'User Logged Out', '2022-10-18 13:31:24', 'Login'),
(1293, 'masteraffy@gmail.com', 'User Logged In', '2022-10-18 13:32:19', 'Login'),
(1294, 'masteraffy@gmail.com', 'User Created an Alumni Account: testemail@email.com', '2022-10-18 13:35:47', 'Admin Account'),
(1295, 'masteraffy@gmail.com', 'User Logged Out', '2022-10-18 13:35:54', 'Login'),
(1296, 'masteraffy@gmail.com', 'User Logged In', '2022-10-18 13:37:55', 'Login'),
(1297, 'masteraffy@gmail.com', 'User Updated an Announcement / Events: 65', '2022-10-18 13:38:25', 'Announcement / Events'),
(1298, 'masteraffy@gmail.com', 'User Logged In', '2022-10-18 18:25:31', 'Login'),
(1299, 'masteraffy@gmail.com', 'User Logged Out', '2022-10-18 18:26:04', 'Login'),
(1300, 'masteraffy@gmail.com', 'User Logged In', '2022-10-18 18:28:25', 'Login'),
(1301, 'masteraffy@gmail.com', 'User Updated an Announcement / Events: 66', '2022-10-18 18:28:34', 'Announcement / Events'),
(1302, '', 'User Logged Out', '2022-10-18 18:29:46', 'Login'),
(1303, 'masteraffy@gmail.com', 'User Logged In', '2022-10-27 13:23:40', 'Login'),
(1304, 'masteraffy@gmail.com', 'User Logged In', '2022-11-14 12:47:56', 'Login'),
(1305, 'masteraffy@gmail.com', 'User Logged In', '2022-11-14 12:51:15', 'Login'),
(1306, 'masteraffy@gmail.com', 'User Logged Out', '2022-11-14 12:51:35', 'Login'),
(1307, 'masteraffy@gmail.com', 'User Logged In', '2022-11-15 05:42:21', 'Login'),
(1308, 'masteraffy@gmail.com', 'User Created an Announcement / Events: ping pong', '2022-11-15 05:43:26', 'Announcement / Events'),
(1309, 'masteraffy@gmail.com', 'User Updated an Announcement / Events: ping pong', '2022-11-15 05:43:38', 'Announcement / Events'),
(1310, 'masteraffy@gmail.com', 'User Logged Out', '2022-11-15 05:50:31', 'Login'),
(1311, 'masteraffy@gmail.com', 'User Logged In', '2022-11-15 05:52:04', 'Login'),
(1312, 'masteraffy@gmail.com', 'User Created an Employee Account: shin@gmail.com', '2022-11-15 05:54:52', 'Employee Account'),
(1313, 'masteraffy@gmail.com', 'User Logged Out', '2022-11-15 05:55:38', 'Login'),
(1314, 'masteraffy@gmail.com', 'User Logged In', '2022-11-15 05:57:38', 'Login'),
(1315, 'masteraffy@gmail.com', 'User Updated an Announcement / Events: 67', '2022-11-15 05:57:53', 'Announcement / Events'),
(1316, 'masteraffy@gmail.com', 'User Updated an Announcement / Events: 62', '2022-11-15 05:57:55', 'Announcement / Events'),
(1317, 'masteraffy@gmail.com', 'User Logged Out', '2022-11-15 05:57:59', 'Login'),
(1318, 'masteraffy@gmail.com', 'User Logged In', '2022-11-15 05:58:58', 'Login'),
(1319, 'masteraffy@gmail.com', 'User Updated an Announcement / Events: 68', '2022-11-15 05:59:04', 'Announcement / Events'),
(1320, 'masteraffy@gmail.com', 'User Created an Announcement / Events: painting', '2022-11-15 05:59:30', 'Announcement / Events'),
(1321, 'masteraffy@gmail.com', 'User Logged Out', '2022-11-15 05:59:36', 'Login'),
(1322, 'masteraffy@gmail.com', 'User Logged In', '2022-11-15 06:18:35', 'Login'),
(1323, 'masteraffy@gmail.com', 'User Updated an Announcement / Events: 69', '2022-11-15 06:18:44', 'Announcement / Events'),
(1324, 'masteraffy@gmail.com', 'User Updated an Announcement / Events: 70', '2022-11-15 06:19:17', 'Announcement / Events'),
(1325, 'masteraffy@gmail.com', 'User Logged Out', '2022-11-15 06:19:22', 'Login'),
(1326, 'masteraffy@gmail.com', 'User Logged In', '2022-11-15 06:20:16', 'Login'),
(1327, 'masteraffy@gmail.com', 'User Logged Out', '2022-11-15 06:21:24', 'Login'),
(1328, 'masteraffy@gmail.com', 'User Logged In', '2022-11-15 06:23:06', 'Login'),
(1329, 'masteraffy@gmail.com', 'User Deleted an Alumni Account: 1700002', '2022-11-15 06:23:17', 'Admin Account'),
(1330, 'masteraffy@gmail.com', 'User Logged Out', '2022-11-15 06:23:33', 'Login'),
(1331, 'masteraffy@gmail.com', 'User Logged In', '2022-11-15 06:33:05', 'Login'),
(1332, 'masteraffy@gmail.com', 'User Created an Alumni Account: aianne1226@gmail.com', '2022-11-15 06:34:50', 'Admin Account'),
(1333, 'masteraffy@gmail.com', 'User Logged Out', '2022-11-15 06:35:20', 'Login'),
(1334, 'masteraffy@gmail.com', 'User Logged In', '2022-11-15 06:36:28', 'Login'),
(1335, 'masteraffy@gmail.com', 'User Deleted an Alumni Account: 1700002', '2022-11-15 06:36:35', 'Admin Account'),
(1336, 'masteraffy@gmail.com', 'User Logged Out', '2022-11-15 06:36:42', 'Login'),
(1337, 'masteraffy@gmail.com', 'User Logged In', '2022-11-15 09:33:50', 'Login'),
(1338, 'masteraffy@gmail.com', 'User Created Branch', '2022-11-15 09:38:57', 'Branch'),
(1339, 'masteraffy@gmail.com', 'User Created Branch', '2022-11-15 09:39:53', 'Branch'),
(1340, 'masteraffy@gmail.com', 'User Created Branch', '2022-11-15 09:40:07', 'Branch'),
(1341, 'masteraffy@gmail.com', 'User Created Branch', '2022-11-15 09:40:24', 'Branch'),
(1342, 'masteraffy@gmail.com', 'User Created Branch', '2022-11-15 09:40:39', 'Branch'),
(1343, 'masteraffy@gmail.com', 'User Logged Out', '2022-11-15 09:42:48', 'Login'),
(1344, 'masteraffy@gmail.com', 'User Logged In', '2022-11-15 13:25:18', 'Login'),
(1345, 'masteraffy@gmail.com', 'User Logged Out', '2022-11-15 13:28:43', 'Login'),
(1346, 'masteraffy@gmail.com', 'User Logged In', '2022-11-15 13:30:01', 'Login'),
(1347, 'masteraffy@gmail.com', 'User Logged Out', '2022-11-15 13:30:20', 'Login'),
(1348, 'masteraffy@gmail.com', 'User Logged In', '2022-11-15 13:31:10', 'Login'),
(1349, 'masteraffy@gmail.com', 'User Logged Out', '2022-11-15 13:33:38', 'Login'),
(1350, 'masteraffy@gmail.com', 'User Logged In', '2022-11-15 13:38:32', 'Login'),
(1351, 'masteraffy@gmail.com', 'User Updated an Announcement / Events: 71', '2022-11-15 13:38:52', 'Announcement / Events'),
(1352, 'masteraffy@gmail.com', 'User Logged In', '2022-11-15 13:46:05', 'Login'),
(1353, 'masteraffy@gmail.com', 'User Logged Out', '2022-11-15 13:50:17', 'Login'),
(1354, 'masteraffy@gmail.com', 'User Logged In', '2022-11-15 15:00:14', 'Login'),
(1355, 'masteraffy@gmail.com', 'User Logged Out', '2022-11-15 15:00:28', 'Login'),
(1356, 'masteraffy@gmail.com', 'User Logged In', '2022-11-15 15:01:44', 'Login'),
(1357, 'masteraffy@gmail.com', 'User Logged Out', '2022-11-15 15:02:00', 'Login'),
(1358, 'masteraffy@gmail.com', 'User Logged In', '2022-12-01 13:36:05', 'Login'),
(1359, 'masteraffy@gmail.com', 'User Created an Admin Account: cs.legarda@arellano.edu.ph', '2022-12-01 13:37:20', 'Admin Account'),
(1360, 'masteraffy@gmail.com', 'User Logged Out', '2022-12-01 13:37:41', 'Login'),
(1361, 'cs.legarda@arellano.edu.ph', 'User Logged In', '2022-12-01 13:37:47', 'Login'),
(1362, 'cs.legarda@arellano.edu.ph', 'User Logged In', '2022-12-19 14:03:48', 'Login'),
(1363, 'cs.legarda@arellano.edu.ph', 'User Logged In', '2023-05-31 13:05:12', 'Login'),
(1364, 'cs.legarda@arellano.edu.ph', 'User Created an Announcement / Events: Sample Event', '2023-05-31 13:06:50', 'Announcement / Events'),
(1365, 'cs.legarda@arellano.edu.ph', 'User Logged In', '2023-05-31 13:58:23', 'Login'),
(1366, 'cs.legarda@arellano.edu.ph', 'User Logged In', '2023-06-01 09:24:18', 'Login'),
(1367, 'cs.legarda@arellano.edu.ph', 'User Logged In', '2023-06-02 09:46:59', 'Login'),
(1368, 'cs.legarda@arellano.edu.ph', 'User Logged In', '2023-07-11 15:00:54', 'Login'),
(1369, 'cs.legarda@arellano.edu.ph', 'User Logged In', '2023-07-14 13:01:56', 'Login'),
(1370, 'cs.legarda@arellano.edu.ph', 'User Logged In', '2023-07-14 13:22:07', 'Login'),
(1371, 'cs.legarda@arellano.edu.ph', 'User Logged In', '2023-07-14 13:53:27', 'Login'),
(1372, 'cs.legarda@arellano.edu.ph', 'User Logged In', '2023-07-14 14:17:26', 'Login'),
(1373, 'cs.legarda@arellano.edu.ph', 'User Logged In', '2023-07-14 15:51:03', 'Login'),
(1374, 'cs.legarda@arellano.edu.ph', 'User Logged In', '2023-07-17 10:25:41', 'Login'),
(1375, 'cs.legarda@arellano.edu.ph', 'User Logged In', '2023-07-17 14:09:00', 'Login'),
(1376, 'cs.legarda@arellano.edu.ph', 'User Logged In', '2023-07-18 09:16:17', 'Login'),
(1377, 'cs.legarda@arellano.edu.ph', 'User Logged In', '2023-08-04 11:16:06', 'Login'),
(1378, 'cs.legarda@arellano.edu.ph', 'User Logged In', '2023-09-28 10:23:33', 'Login'),
(1379, 'cs.legarda@arellano.edu.ph', 'User Updated an Alumni Account: ', '2023-09-28 10:24:44', 'Admin Account'),
(1380, 'cs.legarda@arellano.edu.ph', 'User Updated an Alumni Account: ', '2023-09-28 10:27:04', 'Admin Account'),
(1381, 'cs.legarda@arellano.edu.ph', 'User Updated an Alumni Account: ', '2023-09-28 10:27:05', 'Admin Account'),
(1382, 'cs.legarda@arellano.edu.ph', 'User Updated an Alumni Account: ', '2023-09-28 10:27:37', 'Admin Account'),
(1383, 'cs.legarda@arellano.edu.ph', 'User Updated an Alumni Account: ', '2023-09-28 11:37:49', 'Admin Account'),
(1384, 'cs.legarda@arellano.edu.ph', 'User Updated an Alumni Account: ', '2023-09-28 11:40:08', 'Admin Account'),
(1385, 'cs.legarda@arellano.edu.ph', 'User Logged In', '2023-09-28 11:40:24', 'Login');
...
--
-- Indexes for table `alumnisurvey`
--
ALTER TABLE `alumnisurvey`
  ADD PRIMARY KEY (`Id`);
...
--
ALTER TABLE `alumni`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1700004;
...
--
ALTER TABLE `logs`
  MODIFY `log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1386;
