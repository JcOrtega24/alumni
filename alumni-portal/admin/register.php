                    ...
                    <div class="modal-body">
                        <div class="row d-none">
                            <div class="form-group col-6">
                                ...
                                <input type="text" value=" " name="employeeNo" class="form-control" placeholder="Enter Employee Number" required>
                            ...
                            <div class="form-group col-6">
                                ...
                                <input type="text" value=" " name="email" class="form-control" placeholder="Enter Username" required>
                                <div class="valid-feedback">Valid.</div>
                                <div class="invalid-feedback">Please fill out this field.</div>
                            </div>
                        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <label>First Name:</label>
                                    <input type="text" name="firstname" onKeyDown="return /[a-z]/i.test(event.key)" id="firstname" class="form-control" placeholder="Enter First" required>
                                    <div class="valid-feedback">Valid.</div>
                                    <div class="invalid-feedback">Please fill out this field.</div>
                                </div>
                                ...
                                <div class="col-4">
                                    <label>Middle Name:</label>
                                    <input type="text" name="middlename" onKeyDown="return /[a-z]/i.test(event.key)" id="middlename" class="form-control" placeholder="Enter Middle" required>
                                    <div class="valid-feedback">Valid.</div>
                                    <div class="invalid-feedback">Please fill out this field.</div>
                                </div>
                                <div class="col-4">
                                    ...
                                    <label>Last Name:</label>
                                    <input type="text" name="lastname" onKeyDown="return /[a-z]/i.test(event.key)" id="lastname" class="form-control" placeholder="Enter Last" required>
                                    <div class="valid-feedback">Valid.</div>
                                    <div class="invalid-feedback">Please fill out this field.</div>
                                </div>
                            </div>
                        ...
                        <div class="row d-none">
                            ...
                            <div class="form-group col-6">
                                <label>Confirm Password:</label>
                                <input type="password" name="confirmpassword" id="cpass" class="form-control" placeholder="Enter Confirm Password" required>
                            </div>
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            ...
            <?php
            $query = "SELECT * FROM accounts where userData = 'Administrator'";
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button data-id="<?php echo $row['Id']; ?>" data-empid="<?php echo $row['IdNumber']; ?>" data-fname="<?php echo $row['FirstName']; ?>" data-mname="<?php echo $row['MiddleName']; ?>" data-lname="<?php echo $row['LastName']; ?>" data-username="<?php echo $row['Username']; ?>" data-email="<?php echo $row['Email']; ?>" data-contact="<?php echo $row['ContactNumber']; ?>" data-pass="<?php echo $row['Password']; ?>" data-branchid="<?php echo $row['BranchId']; ?>" ; data-departmentid="<?php echo $row['DepartmentId']; ?>" data-department="<?php
