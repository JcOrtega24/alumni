            ...
            <form action="code.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-6">
                            <label>Contact #:</label>
                            <input type="number" autocomplete="off" tabindex="9" onKeyDown="if(this.value.length==11 && event.keyCode!=8) return false;" onKeypress="return event.keyCode === 8 || event.charCode >= 48 && event.charCode <= 57" name="contact" id="contact_insert" class="form-control" required placeholder="Enter contact #">
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-6 ">
                            ...
                            <input tabindex="13" name="studNo" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="form-control format-studNo" id="" required placeholder="Ex: 18-00001">
                        </div>
                        <div class="form-group col-6 ">
                            <label>Status:</label>
                ...
                <form action="code.php" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                <label>Contact #:</label>
                                <input type="number" autocomplete="off" tabindex="10" onKeyDown="if(this.value.length==11 && event.keyCode!=8) return false;" onKeypress="return event.keyCode === 8 || event.charCode >= 48 && event.charCode <= 57" name="contact" id="contact" class="form-control" required placeholder="Enter contact #">
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-6 ">
                                <label>Student Number:</label>
                                <input tabindex="13" disabled name="studNo" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="form-control format-studNo" id="" required placeholder="Ex: 18-00001">
                            </div>
                            <div class="form-group col-6 ">
                                <label>Status:</label>
