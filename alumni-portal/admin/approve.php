    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <?php
                $query = "SELECT *, events.id as Event_ID FROM events left join alumni on events.CreatedUser = alumni.id where UserType='Alumni' AND AllowPost='Pending'";
