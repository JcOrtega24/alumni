                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="form-group col-12">
                                <label>Title:</label>
                                <input type="text" required name="Title" class="form-control" placeholder="Enter Content Title" required>
                                <div class="valid-feedback">Valid.</div>
                                <div class="invalid-feedback">Please fill out this field.</div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-12">
                                ...
                                <input type="text" required name="Subtitle" class="form-control" placeholder="Enter Content Subtitle" required>
                                <div class="valid-feedback">Valid.</div>
                                <div class="invalid-feedback">Please fill out this field.</div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                ...
                                <select name="Specialization" required class="form-control" required>
                                    <div class="valid-feedback">Valid.</div>
                                    <div class="invalid-feedback">Please fill out this field.</div>
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            ...
            <?php
            $query = "SELECT * FROM events left join accounts on events.CreatedUser = accounts.Id where TypeOfContent ='Jobs'";
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button data-id="<?php echo $row['id']; ?>" data-title="<?php echo $row['Title']; ?>" data-branchid="<?php echo $row['specialization']; ?>" data-subtitle="<?php echo $row['Subtitle']; ?>" data-user="<?php echo $row['CreatedUser']; ?>" data-date="<?php echo $row['CreatedDate']; ?>" data-type="<?php echo $row['TypeOfContent']; ?>" data-description="<?php echo $row['Description']; ?>" data-specialization="<?php echo $row['specialization']; ?>" data-location="<?php echo $row['location']; ?>" data-file="<?php echo $row['Image']; ?>" data-departmentid="<?php echo $row['course']; ?>" data-department="<?php
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        } ?>" style='border-radius: 8px;  margin-right: 5px;' class="btn btn-primary edit_btn" data-toggle="modal" data-target="#updateadminprofile">
