            ...
            <div class="modal-body">
                <div class="row">                    
                    <div class="form-group col-12">
                        ...
                        <select name="department" required class="form-control checkBranch" required>
                ...
                <div class="row">
                    <div class="form-group col-12">
                        ...
                        <input type ="text"  required name="Name" class="form-control" placeholder="Ex: Bachelor of Science in Computer Science" required>
                         <div class="valid-feedback">Valid.</div>
                         <div class="invalid-feedback">Please fill out this field.</div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-12">
                        ...
                        <input type ="address"  required name="address" class="form-control text-uppercase" placeholder="Ex: BSCS" required>     
                         <div class="valid-feedback">Valid.</div>
                         <div class="invalid-feedback">Please fill out this field.</div>
       ...
       <div class="container mt-3">
        <form action="code.php" class="was-validated" method="POST"> 
            <div class="modal-body">
                ...
                <div class="form-group col-12">
                        <label>School Deparment:</label>
                        <select name="department" required id="department" class="form-control checkBranch" required>
                         <div class="valid-feedback">Valid.</div>
                         <div class="invalid-feedback">Please fill out this field.</div>
                ...
                <div class="row">
                    <div class="form-group col-12">
                        <label>Course Name:</label>
                        <input type ="text" required name="Name" id="Name" class="form-control" placeholder="Enter Branch Name text-capitalize" required> 
                         <div class="valid-feedback">Valid.</div>
                         <div class="invalid-feedback">Please fill out this field.</div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-12">
                        <label>Course Abbv:</label>                          
                        <input type ="text" id="abvC" required name="address" class="form-control text-uppercase" placeholder="Ex: BSIT" required>  
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">Please fill out this field.</div>
                    </div>
                </div>
