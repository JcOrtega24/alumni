...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo $redirect; ?>">
        <img width="100px" height="100" src="https://th.bing.com/th/id/R.e0b43ac42a832763d30954bc510dcf97?rik=Bwytg72ugln8%2fw&riu=http%3a%2f%2farellano.edu.ph%2finternational%2fsites%2fdefault%2ffiles%2fArellano+hi-res_0.png&ehk=dapCxV1dCduGu4W%2fk00HOBHg0oG4e7yytLO16b7%2fBEg%3d&risl=&pid=ImgRaw&r=0" />
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="announcement.php" data-toggle="collapse" data-target="#collapseContent" aria-expanded="true" aria-controls="collapseContent">
        ...
        <div id="collapseContent" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="admin/approve.php" style="<?php echo "display:" . $display ?>">Approve Postings</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="alumni.php" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
    ...
    <li class="nav-item" style="<?php echo "display:" . $display ?>">
        <a class="nav-link collapsed" href="employee.php" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
    ...
    <!-- Nav Item - Employee Management -->
    <li class="nav-item" style="<?php echo "display:" . $display ?>">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#utility" aria-expanded="true" aria-controls="utility">
            <i class="fas fa-fw fa-wrench"></i>
            <span>Utility</span>
        </a>
        <div id="utility" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
        ...
        <form
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                    <?php
                    $query = "SELECT COUNT(*) as 'count' FROM events WHERE AllowPost='Pending'";
