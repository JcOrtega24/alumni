...
$id = $user["userID"];
$query = "SELECT * FROM alumnisurvey WHERE studID  =" . $id;
$query_run = mysqli_query($connection, $query);
                                        ...
                                        <div class=" col-12">
                                            ...
                                            <div class="mb-3 col-12">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="currentlyEmp" id="yesEmployed" value="Yes" <?php
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="currentlyEmp" id="noEmployed" value="No" <?php
                                                                                                                                                if (($fetched->currentlyEmp) == "No") {
                                                                                                                                                    echo "checked";
                                                                                                                                                } ?>>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="currentlyEmp" id="selfEmployed" value="Self employed" <?php
                            ...
                            <label for="validationCustom10" class="form-label">*In case of unemployed, state your reason(s) why you are unemployed</label><br><b>- <?php echo (($fetched->unEmployed)); ?></b>         
                                            ...
                                            <div class="Employed" style="<?php echo $showNow; ?>">
                                                ...
                                                <div class="mb-3 col-12">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="employementStat" id="inlineRadio1" value="Local" <?php
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="employementStat" id="inlineRadio2" value="Abroad" <?php
                                                ...
                                                <div class="mb-3 col-12">
                                                    ...
                                                    <br />
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="typeOrg" id="inlineRadio1" value="Private" <?php
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="typeOrg" id="inlineRadio2" value="Public" <?php
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="typeOrg" id="inlineRadio1" value="NGO" <?php
                                                ...
                                                <div class="mb-3 col-12">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="presentStatus" id="inlineRadio1" value="Regular/Permanent" <?php
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="presentStatus" id="inlineRadio2" value="Casual" <?php
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="presentStatus" id="inlineRadio1" value="Part Time" <?php
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="presentStatus" id="inlineRadio1" value="Contractual" <?php
                                                ...
                                                <div class="mb-3 col-12">
                                                    ...
                                                    <br>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="courseRelated" id="inlineRadio1" value="Yes" <?php
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="courseRelated" id="inlineRadio2" value="No" <?php
                                                ...
                                                <div class="mb-3 col-12">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="occupationClass" id="inlineRadio1" value="Corporate Executive or Manager" <?php
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="occupationClass" id="inlineRadio1" value="Managing Proprietor or Supervisor" <?php
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="occupationClass" id="inlineRadio1" value="Official of Government and Special Interest Organization" <?php
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="occupationClass" id="inlineRadio1" value="Educational" <?php
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="occupationClass" id="inlineRadio1" value="Laborer or Unskilled Worker" <?php
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="occupationClass" id="inlineRadio1" value="Special Occupation eg. travelling nurse, LPN" <?php
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="occupationClass" id="inlineRadio1" value="Technician or Associate Professional" <?php
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="occupationClass" id="inlineRadio1" value="Trader or Related Worker" <?php
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="occupationClass" id="inlineRadio1" value="Market Sales Worker" <?php
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="occupationClass" id="inlineRadio1" value="Clerk" <?php
                                                ...
                                                <div class="mb-3 col-12">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="compYears" id="inlineRadio1" value="1-5" <?php
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="compYears" id="inlineRadio1" value="6-10" <?php
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="compYears" id="inlineRadio1" value="11-15" <?php
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="compYears" id="inlineRadio1" value="16-20" <?php
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="compYears" id="inlineRadio1" value="21-25" <?php
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="compYears" id="inlineRadio1" value="25 above" <?php
