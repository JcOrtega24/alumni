...
$insert = "INSERT INTO alumnisurvey(Id, studID, Description, AddedDate, courseRelated, currentlyEmp)
VALUES('$id','$id','$form',now(),'$courseRelated', '$currentlyEmp')
";
$result = mysqli_query($connection, $insert);
// print_r($insert);
// $query = "SELECT * FROM alumnisurvey WHERE stu$dID  =".$id;
