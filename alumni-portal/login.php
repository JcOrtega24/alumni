        ...
        <div class="col-lg-10 col-xl-9 card flex-row mx-auto px-0">
          ...
          <div class="card-body">
            <h4 class="title text-center mt-4">
              Login below using your registered account
            </h4>
            <?php
            ...
            ?>
            <form action="auth/login.php" method="POST" class="form-box px-3">
              ...
              <div class="text-right">
                <a href="alumni/forgotForm.php" class="forget-link">
                  Forgot Password?
                </a>
              </div>
              ...
              <div class="text-center mb-2">
                ...
                <a href="alumni/user_registration.php" class="register-link">
                  Register here
                </a>
              </div>
              <hr class="my-4">
